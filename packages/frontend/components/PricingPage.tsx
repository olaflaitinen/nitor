...
import { Check, Zap, Award, BarChart3, ArrowLeft } from 'lucide-react';
...
export const PricingPage: React.FC<PricingPageProps> = ({ onBack }) => {
  return (
    <div className="min-h-screen bg-slate-50 animate-in fade-in slide-in-from-bottom-4">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 relative overflow-hidden">
                ...
                <p className="text-slate-600 mb-8 text-sm">Everything you need to publish and connect.</p>
                ...
                <button className="w-full py-3 rounded-xl border border-slate-200 font-bold text-slate-700 hover:bg-slate-50 transition-colors">
                    Current Plan
                </button>
            </div>
            ...
            <div className="bg-slate-900 p-8 rounded-2xl shadow-xl border border-indigo-500/30 relative overflow-hidden">
                ...
                <button className="w-full py-3 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-500 transition-all shadow-lg shadow-indigo-900/50">
                    Upgrade Now
                </button>
            </div>
        </div>
        ...
        <div className="text-center mt-12 text-sm text-slate-400">
            <p>Universities and Labs: <span className="underline cursor-pointer hover:text-indigo-600">Contact us for enterprise pricing</span>.</p>
        </div>
