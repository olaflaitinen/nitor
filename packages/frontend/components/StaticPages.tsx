...
export const TermsPage: React.FC<{ onBack: () => void, initialSection?: 'tos' | 'integrity' }> = ({ onBack, initialSection = 'tos' }) => {
    const { addToast } = useNitorStore();
    const [activeSection, setActiveSection] = useState<'tos' | 'integrity'>(initialSection);
